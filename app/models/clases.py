...
class Alumno(SQLModel, table=True):
    id_alumno: str = Field(primary_key=True)
    nombre: str
    apellidos: str
    email: str

class Trabajador(SQLModel, table=True):
    id_trabajador: str = Field(primary_key=True)
    nombre: str
    apellidos: str
    email: str
...
class PersonalAux(SQLModel, table=True):
    id_personal_aux: str = Field(foreign_key="Trabajador.id_trabajador")

class Profesor(SQLModel, table=True):
    id_profesor: str = Field(foreign_key="Trabajador.id_trabajador")
